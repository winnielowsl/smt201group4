...
---
![](img/logo.jpg){width=50%}

Kesibumantan is a project under the module SMT201 Geographic Information Systems for Urban Planning by Professor Kam Tin Seong in Singapore Managament University (SMU). 

In Bahasa, Kesibukan means hustle and bustle. Since the project involves studying Kalimantan Timur (East Kalimantan) for Indonesia's new capital, we decided to name the project Kesibumantan which is a combination of Kesibukan + Kalimantan. 
...
Our first objective is to prepare a report of survey covering these aspects of our study area to answer these important questions:
   ...
   * **Population and Demographic**: How is the distribution of economically          active groups and where are the most densely populated areas?
...
The 8 factors considered in this analysis are as follow:
  ...
  * **Economic**: slope levels
  * **Water Transportation**: ferries and boats
  * **Air Transportation**: airports
  * **Safety Hazard**: forest fires
  * **Environment Sustainability**: forests and mangrove forests
  * **Flood Risk**: rivers and coastlines
  * **Building Density**: settlement areas
